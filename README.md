...
## <🚀 프로젝트 배경>
<img width="1205" height="764" alt="image" src="https://github.com/user-attachments/assets/86cc653b-a419-4155-b050-923a43410d3a" />
 <br>
...
- **온라인 교육 시장 성장**
  - 전문기술 분야 교육자 82%, 외국어 분야 교육자 55% → ‘온라인 강의 수강생이 늘었다’고 응답
  - 미국 온라인 학습 플랫폼 유데미(Udemy)도 3월 등록 학습자가 2월 대비 425% 급증했다고 밝힘
  - 전문기술 교육자의 86%, 외국어 교육자의 54% → ‘장기적으로 온라인 강의 수요가 증가할 것’으로 예상

- **이수율 저하**
  - 실제 글로벌 통계에 따르면 온라인 강의의 평균 이수율 3.31%에 불과
...
## 6.4 이상치 제거
  ...
  : 학생 기본 특성이 아닌 학생의 행동 데이터인 studied_credits는 이상치가 모델 성능에 영향을 끼칠 것이라 판단 
  → 이상치 확인 후 모두 제거
